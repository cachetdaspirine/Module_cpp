...
class System{
 public:
  ...
  System(int* Array, int sizeX, int sizeY);
  //-----------------------------------------------------------------------------------------------
  ...
  //Output functions :
  void OutputSpring(char* filename);
  void OutputSite(char* filename);  
  //-----------------------------------------------------------------------------------------------
